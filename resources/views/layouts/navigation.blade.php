...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
        ...
        <x-nav-link href="{{ route('categories.index') }}" :active="request()->routeIs('categories.index')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg"   fill="currentColor" class="w-6 h-6 bi bi-grid-1x2" viewBox="0 0 16 16">
        ...
        <x-nav-link href="{{ route('tags.index') }}" :active="request()->routeIs('tags.index')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 bi bi-virus" viewBox="0 0 16 16">
        ...
        <x-nav-link href="{{ route('posts.index') }}" :active="request()->is('*posts*')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 bi bi-file-ppt" viewBox="0 0 16 16">
        ...
        <x-nav-link href="{{ route('pages.index') }}" :active="request()->is('*pages*')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 bi bi-file-earmark-text" viewBox="0 0 16 16">
