<footer
    class="relative z-10 pt-16 wow fadeInUp bg-primary bg-opacity-5 md:pt-20 lg:pt-24"
    data-wow-delay=".1s"
>
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                <div class="mb-12 max-w-[360px] lg:mb-16">
                    ...
                    <p
                        class="text-base font-medium leading-relaxed text-body-color mb-9"
                    >
                    ...
                    <div class="flex items-center">
                        <a
                            ...
                            class="hover:text-primary mr-6 text-[#CED3F6]"
                        >
                            <svg
                                width="9"
                                height="18"
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div class="mb-12 lg:mb-16">
                    <h2
                        class="mb-10 text-xl font-bold text-black dark:text-white"
                    >
                        Useful Links
                    </h2>
                    <ul>
