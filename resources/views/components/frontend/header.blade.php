<header
    class="absolute top-0 left-0 z-40 flex items-center w-full bg-transparent header"
>
    <div class="container">
        <div class="relative flex items-center justify-between -mx-4">
            <div class="max-w-full px-4 w-60 xl:mr-12">
                <a class="block w-full py-8 header-logo" href="index.html">
                    <img
                        alt="logo"
                        src="/images/logo.png"
                        width="120"
            ...
            <div class="flex items-center justify-between w-full px-4">
                    ...
                    >
                        <ul class="block lg:flex lg:space-x-12">
                            <li class="relative group">
                                <a
                                    class="flex py-2 text-base text-dark group-hover:opacity-70 dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                                    href="{{ route('home') }}"
                                    wire:navigate
                                >
                                    Home
                ...
                <div class="flex items-center justify-end pr-16 lg:pr-0">
                    <a
                        class="hidden py-3 text-base font-bold text-dark px-7 hover:opacity-70 dark:text-white md:block"
                        href="signin/index.html"
                    >
                        Sign In
                    </a>
                    <a
                        class="hidden px-8 py-3 text-base font-bold text-white transition duration-300 rounded-md ease-in-up bg-primary hover:shadow-signUp hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
                    ...
                    <div>
                        ...
                        >
                            <svg
                                viewBox="0 0 23 23"
                                class="w-5 h-5 stroke-current dark:hidden md:h-6 md:w-6"
                                fill="none"
                            >
                                <path
