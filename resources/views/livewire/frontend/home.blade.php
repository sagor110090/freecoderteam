...
<div>
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                    ...
                    >
                        ...
                        >
                            Free and Open-Source Next.js Template for Startup
                            &amp; SaaS
                        </h1>
                        <p
                            class="text-body-color mb-12 text-base font-medium !leading-relaxed dark:text-white dark:opacity-90 sm:text-lg md:text-xl"
                        >
                            Startup is free Next.js template for startups and
                            SaaS business websites comes with all the essential
                            pages, components, and sections you need to launch a
                            complete business website, built-with Next 13.x and
                            Tailwind CSS.
                        </p>
                        <div
                        ...
                        >
                            <a
                                class="px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out rounded-md bg-primary hover:bg-primary/80"
    ...
    <section id="features" class="bg-primary/[.03] py-16 md:py-20 lg:py-28">
        <div class="container">
            <div
                class="w-full mx-auto text-center wow fadeInUp"
                data-wow-delay=".1s"
            ...
            >
                ...
                <p
                    class="text-body-color text-base !leading-relaxed md:text-lg"
                >
            ...
            >
                <div class="w-full">
                    <div class="wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <p
                            class="text-body-color pr-[10px] text-base font-medium leading-relaxed"
                        >
                            Tuae nam ex similique incidunt expedita exerci
                            tationem laudantium. Repellendus quisquam numquam
                            perferendis earum sapiente non tempore? Fugit
                            repellat ut maiores.
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                    ...
                    >
                        <div
                            class="relative aspect-[77/40] items-center justify-center"
                        >
                            <img
                                alt="video image"
                                sizes="100vw"
                                srcset="
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=640&amp;q=75   640w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=750&amp;q=75   750w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=828&amp;q=75   828w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=1080&amp;q=75 1080w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=1200&amp;q=75 1200w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=1920&amp;q=75 1920w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=2048&amp;q=75 2048w,
                                    /_next/image/?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=3840&amp;q=75 3840w
                                "
                                src="_next/image/index1011.html?url=%2Fimages%2Fvideo%2Fvideo.jpg&amp;w=3840&amp;q=75"
                                decoding="async"
                                data-nimg="fill"
                                loading="lazy"
                                style="
    ...
    <section class="pt-16">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                    <div
                        class="wow fadeInUp bg-dark dark:bg-primary flex flex-wrap items-center justify-center rounded-md px-8 py-8 dark:bg-opacity-5 sm:px-10 md:px-[50px] md:py-[40px] xl:p-[50px] 2xl:px-[70px] 2xl:py-[60px]"
                        data-wow-delay=".1s "
                    >
                        <div
    ...
    <section id="about" class="pt-16 md:pt-20 lg:pt-28">
        <div class="container">
            <div
                class="border-body-color/[.15] border-b pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28"
            >
                <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full px-4 lg:w-1/2">
                        ...
                        <div
                            class="wow fadeInUp mb-12 max-w-[570px] lg:mb-0"
                            data-wow-delay=".15s"
                        >
                            <div class="mx-[-12px] flex flex-wrap">
                                <div
                                    class="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2"
                                >
                                    <p
                                        class="flex items-center mb-5 text-lg font-medium text-body-color"
                                    >
                                        <span
                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        <div
                            class="wow fadeInUp relative mx-auto aspect-[25/24] max-w-[500px] lg:mr-0"
                            data-wow-delay=".2s"
                        >
                            <img
                                alt="about-image"
    ...
    <section class="py-16 md:py-20 lg:py-28">
        <div class="container">
            <div class="flex flex-wrap items-center -mx-4">
                <div class="w-full px-4 lg:w-1/2">
                    <div
                        class="wow fadeInUp relative mx-auto mb-12 aspect-[25/24] max-w-[500px] text-center lg:m-0"
                        data-wow-delay=".15s"
                    >
                        <img
                            alt="about image"
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <div
                        class="wow fadeInUp max-w-[470px]"
                        data-wow-delay=".2s"
                    >
                        <div class="mb-9">
                            <h3
    ...
    <section class="bg-primary/[.03] relative z-10 py-16 md:py-20 lg:py-28">
        <div class="container">
            ...
            <div
                class="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3"
            >
                <div class="w-full">
                    <div
                        class="wow fadeInUp shadow-one rounded-md bg-white p-8 dark:bg-[#1D2144] lg:px-5 xl:px-8"
                        data-wow-delay=".1s"
                    >
    ...
    <section id="pricing" class="relative z-10 py-16 md:py-20 lg:py-28">
        <div class="container">
            <div
                class="w-full mx-auto text-center wow fadeInUp"
                data-wow-delay=".1s"
                style="max-width: 665px; margin-bottom: 100px"
            >
                <h2
                    class="mb-4 text-3xl font-bold !leading-tight text-black dark:text-white sm:text-4xl md:text-[45px]"
                >
            ...
            <div class="w-full">
                <div
                    class="flex justify-center mb-8 wow fadeInUp md:mb-12 lg:mb-16"
                    data-wow-delay=".1s"
                >
                    <span
                        class="mr-4 text-base font-semibold cursor-pointer pointer-events-none text-primary"
                    >
                        Monthly
                    </span>
                    <div class="flex items-center cursor-pointer">
                        <div class="relative">
                            <div
                                class="h-5 w-14 rounded-full bg-[#1D2144] shadow-inner"
                            ></div>
                            <div
                            ...
                            >
                                <span
                                    class="w-4 h-4 bg-white rounded-full active"
                                ></span>
                            </div>
                        </div>
                    </div>
                    <span
                        class="ml-4 text-base font-semibold cursor-pointer text-dark dark:text-white"
                    >
                        Yearly
                    </span>
                </div>
            ...
            >
                <div class="w-full">
                    <div
                        class="wow fadeInUp shadow-signUp relative z-10 rounded-md bg-white px-8 py-10 dark:bg-[#1D2144]"
                        data-wow-delay=".1s"
                    >
                        <div class="flex items-center justify-between">
                            <h3
                                class="mb-2 text-3xl font-bold text-black price dark:text-white"
                            >
                                $
                            ...
                            <h4
                                class="mb-2 text-xl font-bold text-dark dark:text-white"
                            >
                                Lite
                            </h4>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <p
                                    class="m-0 text-base font-medium text-body-color"
                                >
                                    All UI Components
                                </p>
                            </div>
    ...
    <section id="blog" class="py-16 bg-primary/5 md:py-20 lg:py-28">
        <div class="container">
            ...
            <div
                class="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 md:gap-x-6 lg:gap-x-8 xl:grid-cols-3"
            >
                <div class="w-full">
                    <div
                        class="relative overflow-hidden bg-white rounded-md wow fadeInUp shadow-one dark:bg-dark"
                        data-wow-delay=".1s"
                    >
                        <a
                            class="relative block h-[220px] w-full"
                            href="index.html"
                        >
                            <span
                        ...
                        <div
                            class="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8"
                        >
                            <h3>
                                <a
                                    class="block mb-4 text-xl font-bold text-black hover:text-primary dark:hover:text-primary dark:text-white sm:text-2xl"
                                    href="index.html"
                                >
                            ...
                            <div class="flex items-center">
                                ...
                                >
                                    <div class="mr-4">
                                        <div
                                            class="relative w-10 h-10 overflow-hidden rounded-full"
                                        >
                                            <img
                                                alt="author"
                                                sizes="100vw"
                ...
                <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
                    ...
                    >
                        ...
                        <form>
                            ...
                            />
                            <p
                                class="text-base font-medium leading-relaxed text-center text-body-color"
                            >
