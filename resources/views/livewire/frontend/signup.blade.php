...
<div>
    <section
        class="relative z-10 overflow-hidden pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]"
    >
        <div class="container">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    ...
                    >
                        ...
                        <p
                            class="text-body-color mb-11 text-center text-base font-medium"
                        >
                        ...
                        <div class="mb-8 flex items-center justify-center">
                            <span
                                class="bg-body-color hidden h-[1px] w-full max-w-[60px] sm:block"
                            ></span>
                            <p
                                class="text-body-color w-full px-5 text-center text-base font-medium"
                            >
                        ...
                        <form>
                            ...
                            <div class="mb-8 flex">
                                <label
                                    for="checkboxLabel"
                                    class="text-body-color flex cursor-pointer select-none text-sm font-medium"
                                >
                                    <div class="relative">
                                        <input
                                            type="checkbox"
                                        ...
                                        />
                                        <div
                                            class="box border-body-color mr-4 mt-1 flex h-5 w-5 items-center justify-center rounded border border-opacity-20 dark:border-white dark:border-opacity-10"
                                        >
                            ...
                            <div class="mb-6">
                                <button
                                    class="bg-primary hover:shadow-signUp flex w-full items-center justify-center rounded-md px-9 py-4 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80"
                                >
                                    Sign up
                                </button>
                            </div>
                        ...
                        <p
                            class="text-body-color text-center text-base font-medium"
                        >
