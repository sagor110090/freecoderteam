        ...
        <div class="container">
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 md:w-2/3 lg:w-1/2 xl:w-1/3">
                    <div
                        class="wow fadeInUp shadow-one dark:bg-dark relative overflow-hidden rounded-md bg-white"
                        data-wow-delay=".1s"
                    >
                        <a
                        ...
                        >
                            <h3>
                                <a
                                    class="hover:text-primary dark:hover:text-primary mb-4 block text-xl font-bold text-black dark:text-white sm:text-2xl"
                                    href="../index.html"
                                >
                            ...
                            <div class="flex items-center">
                                ...
                                >
                                    ...
                                    <div class="w-full">
                                        <h4
                                            class="text-dark mb-1 text-sm font-medium dark:text-white"
                                        >
                                            By
                                            <!-- -->
                                            Samuyl Joshi
