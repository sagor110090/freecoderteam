                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        ...
                        >
                            <div class="mx-[-12px] flex flex-wrap">
                                ...
                                >
                                    <p
                                        class="text-body-color mb-5 flex items-center text-lg font-medium"
                                    >
                                        <span
                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        ...
                        >
                            <img
                                ...
                                decoding="async"
                                data-nimg="fill"
                                class="mx-auto max-w-full lg:mr-0"
                                loading="lazy"
                                style="
                                    position: absolute;
                                    height: 100%;
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    >
                        <div class="mb-9">
                            ...
                            <p
                                class="text-body-color text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed"
                            >
