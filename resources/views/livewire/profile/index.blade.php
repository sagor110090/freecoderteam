<div>
    ...
    <div class="py-12">
        <div class="space-y-6 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white shadow sm:rounded-lg sm:p-8">
                <div class="max-w-xl">
                    <header>
                        ...
                        <form wire:submit="updatePassword" class="mt-6 space-y-6">
                            <div>
                                ...
                                <x-text-input wire:model="current_password" id="update_password_current_password"
                                    name="current_password" type="password" class="block w-full mt-1"
